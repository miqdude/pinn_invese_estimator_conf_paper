...
The PINN effectively minimized the physical rotational residuals defined using the Euler-Poincaré equations in the loss function. The network consistently identified the static CoG offsets ($d_{x, cog}, d_{y, cog}$) within the initial seconds of flight, mapping disturbance torques to spatial asymmetry without requiring persistent excitation maneuvers. In the second episode the PINN was able to estimate the offset, from \ref{fig:body_position_xz_ep_1} the body was immediatly slides to the positive X position right after taking off. The controller was able to correct the sudden slide because the PINN was gradually update it's estimation.
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[
                color=red, 
                line width=1.5pt
            ] table [x=time_sec, y=true_mass_kg, col sep=comma] {data/flight_data_figure_eight_3d_ep_9.csv};
            \addlegendentry{True}
            ...
            \addplot[
                ...
                line width=1pt, 
                dashed 
            ] table [x=time_sec, y=pred_mass_kg, col sep=comma] {data/flight_data_figure_eight_3d_ep_9.csv};
            \addlegendentry{Predicted}
            
        \end{axis}
    \end{tikzpicture}
    \caption{Predicted system mass at $10^{th}$ episode} \label{fig:mass_convergence}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Body frame position on XY-axis at $10^{th}$ episode}
    \label{fig:offset_y_convergence}
\end{figure}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[
                color=red, 
                line width=1.5pt
            ] table [x=target_x_m, y=target_z_m, col sep=comma] {data/flight_data_figure_eight_3d_ep_9.csv};
            \addlegendentry{Target Position}
            ...
            \addplot[
                ...
                line width=1pt, 
                dashed 
            ] table [x=actual_x_m, y=actual_z_m, col sep=comma] {data/flight_data_figure_eight_3d_ep_9.csv};
            \addlegendentry{Actual Position}
            
        \end{axis}
    \end{tikzpicture}
    \caption{Body frame position on XZ-axis at $10^{th}$ episode}
    \label{fig:body_position_xz}
\end{figure}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[
                color=red, 
                line width=1.5pt
            ] table [x=target_x_m, y=target_y_m, col sep=comma] {data/flight_data_figure_eight_3d_ep_9.csv};
            \addlegendentry{Target Position}
            ...
            \addplot[
                ...
                line width=1pt, 
                dashed 
            ] table [x=actual_x_m, y=actual_y_m, col sep=comma] {data/flight_data_figure_eight_3d_ep_9.csv};
            \addlegendentry{Actual Position}
            
        \end{axis}
    \end{tikzpicture}
    \caption{Target position and actual position at $10^{th}$ episode}
    \label{fig:body_position_xy}
\end{figure}
